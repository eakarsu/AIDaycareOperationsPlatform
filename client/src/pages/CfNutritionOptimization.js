...
/**
 * Gap/CFS Feature Page: Nutrition optimization
 * Slug: nutrition-optimization
 * Backend: /api/cf-nutrition-optimization
 */
export default function NutritionOptimizationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-nutrition-optimization', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Nutrition optimization</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Recommend meal plans balancing compliance (allergen, nutritional), preferences, cost.</p>
