...
/**
 * Gap/CFS Feature Page: Curriculum personalization
 * Slug: curriculum-personalization
 * Backend: /api/cf-curriculum-personalization
 */
export default function CurriculumPersonalizationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-curriculum-personalization', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Curriculum personalization</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Auto-suggest activities based on child\'s developmental stage, interests, and learning style.</p>
