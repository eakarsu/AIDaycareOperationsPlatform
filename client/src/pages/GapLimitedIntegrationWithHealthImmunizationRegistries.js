...
/**
 * Gap/CFS Feature Page: Limited integration with health/immunization registries.
 * Slug: limited-integration-with-health-immunization-registries
 * Backend: /api/gap-limited-integration-with-health-immunization-registries
 */
export default function LimitedIntegrationWithHealthImmunizationRegistriesPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-integration-with-health-immunization-registries', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Limited integration with health/immunization registries.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Limited integration with health/immunization registries.</p>
