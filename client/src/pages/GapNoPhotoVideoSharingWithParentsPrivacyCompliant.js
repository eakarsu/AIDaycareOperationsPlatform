...
/**
 * Gap/CFS Feature Page: No photo/video sharing with parents (privacy-compliant).
 * Slug: no-photo-video-sharing-with-parents-privacy-compliant
 * Backend: /api/gap-no-photo-video-sharing-with-parents-privacy-compliant
 */
export default function NoPhotoVideoSharingWithParentsPrivacyCompliantPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-photo-video-sharing-with-parents-privacy-compliant', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No photo/video sharing with parents (privacy-compliant).</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No photo/video sharing with parents (privacy-compliant).</p>
