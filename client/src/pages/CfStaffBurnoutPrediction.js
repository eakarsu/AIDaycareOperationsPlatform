...
/**
 * Gap/CFS Feature Page: Staff burnout prediction
 * Slug: staff-burnout-prediction
 * Backend: /api/cf-staff-burnout-prediction
 */
export default function StaffBurnoutPredictionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-staff-burnout-prediction', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Staff burnout prediction</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Monitor staff workload, incident involvement, retention risk; recommend interventions.</p>
