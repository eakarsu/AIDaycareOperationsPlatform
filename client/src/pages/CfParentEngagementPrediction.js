...
/**
 * Gap/CFS Feature Page: Parent engagement prediction
 * Slug: parent-engagement-prediction
 * Backend: /api/cf-parent-engagement-prediction
 */
export default function ParentEngagementPredictionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-parent-engagement-prediction', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Parent engagement prediction</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Identify at-risk children (flagged for early intervention); send proactive parent outreach.</p>
