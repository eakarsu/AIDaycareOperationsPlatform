...
const valid = {
  ...
  "childRef": "childRef-value",
  "guardianRef": "guardianRef-value",
  "consentRef": "consentRef-value",
  "carePlanRef": "carePlanRef-value"
};
...
test('state machine blocks skipped states and safety holds', () => {
  ...
  const result = authorizeTransition({
    ...
    to: 'consent_verified',
    actor,
    evidence: [{"kind":"consent_record"}],
    flags: [POLICY.stopFlags[0]],
    approval: { actorId: 'actor-2', role: 'director', reason: 'reviewed' },
  });
